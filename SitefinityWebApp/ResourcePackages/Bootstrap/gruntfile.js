	...
	grunt.initConfig({
		...
		concat: {
		    ...
		    dist: {
		        src: ['node_modules/jquery/dist/jquery.js',
                    ...
                    'node_modules/jquery-sortable/jquery-sortable.js',
		...
		uglify: {
		    options: {
				...
				report: 'gzip',
				warnings: true,
		        sourceMappingURL: '/ResourcePackages/Bootstrap/assets/dist/js/bootstrap.min.js.map',
                sourceMapRoot: '/ResourcePackages/Bootstrap/assets/dist/js/'
			},
			dist: {
				options: {
					mangle: true,
				...
				files: {
				    '<%= dist.path %>/js/bootstrap.min.js': ['<%= dist.path %>/js/bootstrap.js']
				}
			}
		},
